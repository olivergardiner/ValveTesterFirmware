...
This application is a complement to the Software project and enables PC control of the Valve Analyser such that it can run tests and display the results graphically.
